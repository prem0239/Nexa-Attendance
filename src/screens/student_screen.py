...
def student_screen():
    ...
    if photo_source:
        ...
        with st.spinner('AI is scanning....'):
            detected, allids, num_faces = predict_attendance(img)
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter Your name", placeholder = "E.g Prem Bhoi")
            ...
            try:
                audio_data = st.audio_input('Recorder a short phase like i am Present, My name is Akash.')
            except Exception:
